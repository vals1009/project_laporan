    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col text-end">
                <a href="{{ route('laporanBDP.create') }}" class="btn btn-primary">Tambah Laporan</a>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($laporan as $laporan)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('laporanBDP.edit', $laporan->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                <form action="{{ route('laporanBDP.destroy', $laporan->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
