...
<html lang="en">
    ...
    <div class="container px-5">
        <a class="navbar-brand" href="index.html">Laporan pkl pmb</a>
            ...
            <header class="bg-dark py-5">
                <div class="container px-5">
                    <div class="row gx-5 align-items-center justify-content-center">
                        ...
                        <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="{{ asset('img/pp 1.png') }}" alt="..." /></div>
                    </div>
                </div>
            </header>
            <!-- Features section-->
