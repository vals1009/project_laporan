    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col text-end">
                <a href="{{ route('laporanOTKP.create') }}" class="btn btn-primary">Tambah Laporan</a>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($laporan as $laporan)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('laporanOTKP.edit', $laporan->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                <form action="{{ route('laporanOTKP.destroy', $laporan->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
